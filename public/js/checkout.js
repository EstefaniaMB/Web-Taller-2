fetch('http://localhost:1889/productosPorIds?ids=' + arreglo)
    ...
    .then(function (res) {
        ...
        res.forEach(function (elem, position) {
            lista.innerHTML += '<li  class="cartListItem"> <div class="cartItem"> <div class="img_item"> <img src="'+ elem.imagen +'" alt=""> </div>'+ '<div class="txt_item"> <h4>' + elem.nombre + '</h4> <p>' + elem.precio +'</p></div><div class="priceItem"><p><strong>$'+ elem.precio;
